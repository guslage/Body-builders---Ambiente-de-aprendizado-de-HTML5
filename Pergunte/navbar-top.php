...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
        ...
        <div class="collapse navbar-collapse" id="exCollapsingNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="Duvidas.php" class="nav-link"><button class="btn btn-info">Dúvidas</button></a></li>
                <li class="nav-item"><a href="PergunteAlgo.php" class="nav-link"><button class="btn btn-warning">Pergunte Algo!</button></a></li>
            </ul>
                <?php 
            ...
            <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                <li class="dropdown order-1">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right mt-2">
                       <li class="px-3 py-1" style="border: none">
                            <!--Inicio do menu de ações do usuário-->
                            <img id="usuario-img" src="../Img/<?php echo $foto; ?>">
                            <hr>
                            <?php if ($nivelAcesso == 1) {
                              $link = "../usuarios/Adm.php?id=".$_SESSION['usuario_id']."";
                            }else{
                              $link = "../Usuarios/usuario.php?id=".$_SESSION['usuario_id']."";
                            } ?>
              ...
              <?php }else{ $_SESSION['usuario_id'] = 0;?> 
                      <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                        <li class="dropdown order-1">
